    ...
    return (
      <div className='item container'>
          ...
          <div className='content'>
            <Link to={{pathname: '/company/job/student/application', state: {student: this.state.student}}}>
            <button className='ui right floated basic primary button'>
              View Details
            </button>
            </Link>
            <a className='header'><h4>{this.state.student_name} | Application ID: {this.props.application.application_id}</h4></a>
            <div className='meta'>
