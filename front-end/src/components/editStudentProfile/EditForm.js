...
class EditForm extends React.Component {
  ...
  onSave = e => {
    ...
    const data = {
      institution_name:
        this.state.institution_name == ''
          ? this.props.data.institution_name
          : this.state.institution_name,
      degree:
        this.state.degree == '' ? this.props.data.degree : this.state.degree,
      major: this.state.major == '' ? this.props.data.major : this.state.major,
      passing_year:
        this.state.passing_year == ''
          ? this.props.data.passing_year
          : this.state.passing_year,
    ...
    axios
      .put(`http://18.206.154.118:8080/api/student/education/${id}`, data, {
